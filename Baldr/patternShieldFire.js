...
export function render(index) {
  // Use this fake index to mirror it vertically, so the flames look like they're going up
  var fakeIndex = index;
  if (index > pixelCount / 2) {
    fakeIndex = pixelCount - index;
  }
  // map temperature to display pixel, gamma correct and display  
  k = heat[mapModes[mode](fakeIndex + 1)]
  k = k * k * k;
